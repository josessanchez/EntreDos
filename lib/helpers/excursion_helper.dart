        ...
        content: Column(
          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              value: null,
              items: ['Cultural', 'Deportiva', 'Naturaleza', 'Otro']
                  .map(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () async {
              ...
              await FirebaseFirestore.instance.collection('excursiones').add({
                'titulo': titulo,
