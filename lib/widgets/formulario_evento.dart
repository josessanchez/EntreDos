  ...
  Future<void> guardarEvento() async {
    ...
    if (documento != null && documentoNombre != null) {
      ...
      final ref = FirebaseStorage.instance.ref().child(
        'eventos/${widget.hijoId}/$documentoNombre',
      );
    ...
    final eventoFinal = Evento(
      ...
      documentoNombre:
          documentoNombre ?? widget.eventoExistente?.documentoNombre,
          ...
          return Column(
            ...
            children: [
              ...
              DropdownMenu<String>(
                ...
                onSelected: (v) =>
                    setState(() => tipoSeleccionado = v ?? 'Actividad'),
              ...
              if (documento != null &&
                  ['jpg', 'jpeg', 'png'].contains(
                    documento!.path.split('.').last.toLowerCase(),
                  )) ...[
                const SizedBox(height: 12),
                ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: Image.file(documento!, height: 120, fit: BoxFit.cover),
                ),
              ],
            ],
          );
